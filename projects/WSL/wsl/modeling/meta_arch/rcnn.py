...
from wsl.modeling.roi_heads import DMILROIHeadsV1
...
class GeneralizedRCNNWSL(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.load_proposals = load_proposals
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "roi_heads": DMILROIHeadsV1(cfg, backbone.output_shape()),
            "input_format": cfg.INPUT.FORMAT,
            "vis_period": cfg.VIS_PERIOD,
            "pixel_mean": cfg.MODEL.PIXEL_MEAN,
            "pixel_std": cfg.MODEL.PIXEL_STD,
            "cpg": True
            if "CSC" in cfg.MODEL.ROI_HEADS.NAME
