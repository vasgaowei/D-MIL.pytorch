...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 09:59:48 2019
...
import _init_paths
from model.test_corloc import test_net
...
def combined_roidb(imdb_names):
  ...
  if len(roidbs) > 1:
    for r in roidbs[1:]:
      roidb.extend(r)
    imdb0 = get_imdb(imdb_names.split('+')[0])
    imdb1 = get_imdb(imdb_names.split('+')[1])
  else:
    imdb = get_imdb(imdb_names)
  return imdb0,imdb1,roidb
